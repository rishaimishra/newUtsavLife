...
@section('title')
<title>Utsavlife | Vendor | Address add</title>
@endsection
@section('left_part')
...
<div class="content-page">
    ...
    <div class="content">
        <div class="wraper container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Address add </h4>
                    ...
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            <div class="panel-body rm02 rm04">
                                ...
                                <form method="POST" action="{{ route('vandor.address.ins') }}"  class="form-horizontal m-t-20" id="reg_form">
                                    @csrf
                                   ...
                                   {{--  <div class="form-group">
                                    ...
                                    <button class="btn btn-primary btn-lg w-lg waves-effect waves-light rm01" style="margin-top:200px" type="submit">Add</button>
