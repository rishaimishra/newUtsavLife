					...
					<div>
						...
						<div class="panel panel-default panel-fill">
							...
							<div class="add-btn "><a href="{{route('admin.service.list')}}"><i class="icofont-minus-circle"></i> Back</a></div>
								...
								<form role="form" action="{{route('admin.insert.service')}}" id="frm" method="post" enctype="multipart/form-data">
									@csrf
									...
									<div class="form-group rm50">
										...
										<input type="text"  class="form-control"  placeholder="Enter service name"  name="service" >
									</div>

									<div class="clearfix"></div>
									<div class="form-group rm50">
										<label for="title">service Description</label>
										<textarea  class="form-control"  placeholder="Enter service description"  name="description" ></textarea>
									</div>
									...
									<div class="form-group rm50">
										...
										<input type="text"  class="form-control"  placeholder="Enter Discount Price"  name="price_basis" >
									</div>
