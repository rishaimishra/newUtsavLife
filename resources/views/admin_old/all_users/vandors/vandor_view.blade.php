...
<div class="content-page">
	...
	<div class="content">
		...
		<div class="wraper container-fluid">
			...
			<div class="row">
				<div class="col-sm-12">
					<h4 class="pull-left page-title">vandor View Page</h4>
					<ol class="breadcrumb pull-right">
						<li><a href="{{route('admin.dashboard')}}">Go party</a></li>
						
						<li class="active">vandor View Page</li>
					</ol>
				</div>
			</div>
								...
								<div class="panel panel-default panel-fill">
									...
									<div class="panel-body">
										...
										<div class="about-info-p">
											...
											<br>
											<p class="text-muted">@if(@$vandor->status=="A")
												<p>Active</p>
										...
										<div class="about-info-p">
											...
											<br>
											<p class="text-muted">{{@$vandor->created_at}}</p>
										</div>
										<div class="about-info-p">
											<strong>Last update Time</strong>
											<br>
											<p class="text-muted">{{@$vandor->updated_at}}</p>
										</div>
								...
								<div class="panel panel-default panel-fill">
									...
									<div class="panel-body">
										<div class="about-info-p">
											<strong>Image </strong>
											<br>
											<div class="pull-left"> @if(@$vandor->avatar)
											<img src="{{url('/')}}/storage/app/public/vandor/{{$vandor->avatar}}" alt="" class="thumb-md img-circle">@else<i class='fas fa-user-tie' style='font-size:36px;color: black;'  ></i> @endif </div>
										</div>
