...
@section('title')
<title>Go party | admin | category Edit</title>
@endsection
@section('left_part')
					...
					<div>
						...
						<div class="panel panel-default panel-fill">
							<div class="panel-body rm02 rm04">
								...
								<form role="form" action="{{route('admin.update.category')}}" id="frm" method="post" enctype="multipart/form-data">
									@csrf
									...
									<div class="form-group rm50">
										...
										<input type="text"  class="form-control"  placeholder="Enter company name"  name="category_name" value="{{@$cat->category_name}}" >
									</div>
									<div class="clearfix"></div>
									<div class="form-group rm50">
										<label for="title">category Description</label>
										<textarea  class="form-control"  placeholder="Enter category description"  name="category_description" >{{@$cat->category_description}}</textarea>
									</div>
									{{-- image --}}
									...
									<div class="form-group" style="margin-left: 30px;">
										...
										<div class="uplodimgfilimgs">
											<em><img src="{{url('/')}}/storage/app/public/category/{{@$cat->image}}" alt="" style="width: 150px !important; height: 150px !important"></em>
										</div>
									</div>
