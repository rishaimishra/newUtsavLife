...
@section('title')
<title>Go party | admin | category</title>
@endsection
@section('left_part')
				...
				<div class="col-md-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading rm02 rm04">
							<div class="add-btn "><a href="{{route('admin.category.add.page')}}"><i class="icofont-plus-circle"></i> Add category</a></div>
						</div>
										...
										<table id="example" class="cell-border">
											...
											<tbody>
												...
												<tr>
													...
													<td data-label="Name">{{@$value->category_name}}</td>
													
													<td data-label="Mail ID">@if(@$value->category_status=="A")
														<p>Active</p>
														@else
														<p>Deactive</p>
													@endif</td>
													<td class="rm07">
														...
														<ul>
															@if(@$value->category_status=="A")
															<li><a href="{{route('admin.category.deactive',$value->id)}}">Deactive</a></li>
															@else
															<li><a href="{{route('admin.category.active',$value->id)}}">Active</a></li>
															@endif
															<li><a href="{{route('admin.category.edit',$value->id)}}">Edit</a></li>
															
															<li><a onclick="return confirm('Are you sure want to delete this service ?')" href="{{route('admin.category.delete',$value->id)}}">Delete</a></li>
												...
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<div class="modal-body">
															...
															<em><img src="{{url('/')}}/storage/app/public/category/{{@$value->image}}" alt="" style="width: 150px !important; height: 150px !important"></em>
															
															<h5>Category Desc </h5>
															<p>{{@$value->category_description}}</p>

															
															<h5> category_status </h5>
															<p>@if(@$value->category_status=="A")
																<p>Active</p>
																@else
																<p>Deactive</p>
															@endif</p>
