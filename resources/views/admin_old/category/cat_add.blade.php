...
@section('title')
<title>Go party | admin | category add</title>
@endsection
@section('left_part')
							...
							<div class="panel-body rm02 rm04">
								...
								<form role="form" action="{{route('admin.insert.category')}}" id="frm" method="post" enctype="multipart/form-data">
									...
									<div class="form-group rm50">
										...
										<input type="text"  class="form-control"  placeholder="Enter company name"  name="category_name" >
									</div>
									<div class="clearfix"></div>
									<div class="form-group rm50">
										<label for="title">category Description</label>
										<textarea  class="form-control"  placeholder="Enter category description"  name="category_description" ></textarea>
									</div>
									{{-- image --}}
