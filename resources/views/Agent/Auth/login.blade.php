...
@section('title')
<title>Utsavlife | Agent | Login</title>
@endsection
{{-- @section('head') --}}
            ...
            <div class="col-md-6 m-auto">
                <div class="login_header">
                    <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a href="{{route('agent.login.view')}}" class="nav-link active">Agent Login</a>
                        </li>
                    </ul>
                </div>
                <div class="tab-content mt-5" id="myTabContent">
                    <div class="tab-pane fade show active" id="customer" role="tabpanel" aria-labelledby="home-tab">
                        <div class="login_form shadow">
                            <form  method="POST" action="{{ route('agent.login.post') }}" id="login_form">
                                @csrf
                                 <input type="hidden" name="type" value="web">
                                <input type="hidden" name="user_type" value="customer">
                                <div class="form_title">
                                    <h4>Agent Login</h4>
                                    <p>Don't have an account? <a href="{{route('agent.registration.view')}}">Create here</a></p>
                                </div>
                                ...
                                <div class="input_footer">
                                    ...
                                    <a href="{{route('agent.fgp.enter.mail.page')}}">Forgot Password?</a>
                                </div>
                                <div class="input_footer">
                            ...
                            <div class="input_footer mt-4">
                                <a href="{{route('agent.login.otp.enter.mail')}}"> <span>Login Through OTP</span></a>
                            </div>

                            <div class="social_login">

                                <a href="{{route('login.social',['user_type'=>'agent','provider_type'=>'google'])}}" class="common-btns  google-btn">
                                    
                                    <img src="{{url('/')}}/public/newDesignAsset/dist/images/google.png">
                                </a>
                                <a  href="{{route('login.social',['user_type'=>'agent','provider_type'=>'facebook'])}}" class="common-btns facebook-btn">
