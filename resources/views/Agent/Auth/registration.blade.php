...
@section('title')
<title>Utsavlife | Agent | Registration</title>
@endsection
{{-- @section('head') --}}
            ...
            <div class="col-md-6 m-auto">
                <div class="login_header">
                    <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a href="{{route('agent.registration.view')}}" class="nav-link active">Agent Registration</a>
                        </li>
                    </ul>
                </div>
                <div class="tab-content mt-5" id="myTabContent">
                    <div class="tab-pane fade show active" id="customer" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <div class="login_form shadow">
                            <form   method="POST" action="{{ route('agent.registration.post') }}" id="reg_form" >
                                @csrf
                                <input type="hidden" name="user_type" value="customer">
                                <div class="form_title">
                                    <h4>Create An Account (Agent)</h4>
                                    
                                    <p>Allready Sign Up? <a href="{{route('agent.login.view')}}">Login</a></p>
                            ...
                            <div class="social_login">
                                <a href="{{route('login.social',['user_type'=>'agent','provider_type'=>'facebook'])}}" ><img src="{{url('/')}}/public/newDesignAsset/dist/images/fb.png"></a>
                                <a href="{{route('login.social',['user_type'=>'agent','provider_type'=>'google'])}}" ><img src="{{url('/')}}/public/newDesignAsset/dist/images/google.png"></a>
                            </div>
                            @endif
                        </div>
