...
@section('title')
<title>Utsavlife | Vandor | Leads add</title>
@endsection
@section('left_part')
...
<div class="content-page">
	...
	<div class="content">
		<div class="wraper container-fluid">
			<div class="row">
				<div class="col-sm-12">
					<h4 class="pull-left page-title">Leads Add </h4>
					<ol class="breadcrumb pull-right">
						<li><a href="{{route('agent.dashboard')}}">Utsavlife</a></li>
						<li class="active"> Leads Add </li>
					</ol>
				</div>
			</div>
				...
				<div class="col-lg-12">
					<div>
						...
						<div class="panel panel-default panel-fill">
							...
							<h3 class="panel-title">Add leads</h3> 
							<div class="add-btn "><a href="{{route('agent.lead.list')}}"><i class="icofont-minus-circle"></i> Back</a></div>
							</div>
								<form role="form" action="{{route('agent.lead.ins')}}" id="frm" method="post" enctype="multipart/form-data">
									@csrf
									...
									<div class="form-group rm50">
										...
										<input type="text"  class="form-control"  placeholder="Enter user name"  name="lead_name" >
									</div>
									<div class="clearfix"></div>
									<div class="form-group rm50">
										<label for="title">Address</label>
										<textarea  class="form-control"  placeholder="Enter address"  name="lead_address" ></textarea>
									</div>
									<div class="clearfix"></div>
									<div class="form-group rm50">
										<label for="title">City</label>
										<input type="text"  class="form-control"  placeholder="Enter user name"  name="lead_city" >
									</div>
									<div class="clearfix"></div>
									<div class="form-group rm50">
										<label for="title">Pin</label>
										<input type="text"  class="form-control"  placeholder="Enter user name"  name="lead_pin" >
									</div>
									<div class="clearfix"></div>
									<div class="form-group rm50">
										<label for="title">User Email</label>
										<input type="text"  class="form-control"  placeholder="Enter user email"  name="lead_email" >
									</div>
									<div class="clearfix"></div>
									<div class="form-group rm50">
										<label for="title">User Mobile</label>
										<input type="text"  class="form-control"  placeholder="Enter user mobile"  name="lead_phone" >
									</div>
									<div class="clearfix"></div>
									<div class="clearfix"></div>
