...
@include('Agent.includes.headAuth')
                ...
                <div class="login_wrap_area">
                    <div class="loginwrap">
                        <div class="heading-login">
                            <h1 class="mb-5">Agent Forget password (Enter New Password)</h1>
                            <p class="mb-30">Don't have an account? <a href="{{route('agent.registration.view')}}">Create here</a></p>
                        </div>
                        @include('vandor.includes.message')
                        <form method="POST" action="{{route('agent.reset.new.password')}}"  id="login_form">
                            @csrf
...
@endsection
  @section('script')
    @include('Agent.includes.scriptAuth')
