...
<html>
    <head>
        <title>Order Assign from Admin to Vandor</title>
            ...
            <div style="max-width:620px; border:1px solid #d9d8d8; margin:0 0; padding:15px; ">
                <div style="display:block; overflow:hidden; width:100%;">
                    ...
                    <p>
                        ...
                        You have been assigned with new order. Please go to the website and please accept the order.
                        {{-- The order id is: {{$data['order_id']}} <br> --}}
