...
<head>
    <title>Order Status From Vandor</title>
        ...
        <div style="max-width:620px; border:1px solid #d9d8d8; margin:0 0; padding:15px; ">
            ...
            <div style="display:block; overflow:hidden; width:100%;">
                ...
                <p>
                    ...
                    The order id {{$data['order_id']}} has been approved by vandor : {{$data['vandor_name']}}
                    <br>
                    vandor email is: {{$data['vandor_email']}}
                    @else
                     The order id {{$data['order_id']}} has been rejected by vandor : {{$data['vandor_name']}}
                    <br>
                    vandor email is: {{$data['vandor_email']}}
                    <br>
                    reason is : {{@$data['reason']}}
