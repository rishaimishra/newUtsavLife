...
@section('title')
<title>Utsavlife | Agent | Update Email</title>
@endsection
@section('left_part')
...
<div class="content-page">
	...
	<div class="content">
		<div class="wraper container-fluid">
			...
			<div class="add-btn "><a href="{{route('agent.update.email.page')}}"><i class="icofont-minus-circle"></i> Back</a></div>
			<div class="row">
				<div class="col-lg-12">
					<div>
						...
						<div class="panel panel-default panel-fill">
							...
							<div class="panel-body rm02 rm04">
								<form role="form" action="{{route('agent.email.update.part.two')}}" id="frm" method="post" enctype="multipart/form-data" >
									@csrf
									...
									<div class="col-lg-12">
										<button class="btn btn-primary waves-effect waves-light w-md" type="submit">Update Email</button>
									</div>
								</form>
