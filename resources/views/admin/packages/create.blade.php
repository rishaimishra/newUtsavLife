...
@section('title')
    <title>Go party | admin | Package add</title>
@endsection
@section('left_part')
    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="wraper container-fluid">
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="pull-left page-title">Package Add </h4>
                        ...
                        <div>
                            ...
                            <div class="panel panel-default panel-fill">
                                <div class="panel-body rm02 rm04">
                                    ...
                                    <form role="form" action="{{ route('admin.packages.store') }}" id="frm"
                                        ...
                                        <div class="form-group rm50">
                                            ...
                                            <textarea class="form-control" placeholder="Enter Package description" id="editor" name="description"></textarea>
                                        </div>
