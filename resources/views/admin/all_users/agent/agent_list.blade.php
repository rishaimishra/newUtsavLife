...
@section('title')
<title>Utsavlife | admin | Agent</title>
@endsection
@section('left_part')
											...
											<tbody>
												...
												<tr>
													...
													<td class="rm07">
														...
														<ul>
															@if(@$value->status=="A")
															<li><a href="{{route('admin.agent.deactive',$value->id)}}">Deactive</a></li>
															@elseif(@$value->status=="U")
															<li><a href="{{route('admin.agent.active',$value->id)}}">Active</a></li>
															@else
															<li><a href="{{route('admin.agent.active',$value->id)}}">Active</a></li>
															@endif
														
															
															<li><a onclick="return confirm('Are you sure want to delete this agent ?')" href="{{route('admin.agent.delete',$value->id)}}">Delete</a></li>

															<li><a href="{{route('admin.agent.view',$value->id)}}">View</a></li>
