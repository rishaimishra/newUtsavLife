...
<div class="content-page">
	...
	<div class="content">
		...
		<div class="wraper container-fluid">
			...
			<div class="row">
				<h1> Details of {{@$agent->name}} </h1>
				<div class="col-lg-12">
					
					<div>
						@if(@$agent->status=="A")
						<li><a href="{{route('admin.agent.deactive',$agent->id)}}">Deactive</a></li>
						@elseif(@$agent->status=="U")
						<li><a href="{{route('admin.agent.active',$agent->id)}}">Active</a></li>
						@else
						<li><a href="{{route('admin.agent.active',$agent->id)}}">Active</a></li>
						@endif
					
						
						<li><a onclick="return confirm('Are you sure want to delete this agent ?')" href="{{route('admin.agent.delete',$agent->id)}}">Delete</a></li>
