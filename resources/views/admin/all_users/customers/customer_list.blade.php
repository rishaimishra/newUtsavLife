...
@section('title')
<title>Utsavlife | admin | Customer</title>
@endsection
@section('left_part')
										...
										<table id="example" class="cell-border">
											...
											<tbody>
												...
												<tr>
													...
													{{-- <td data-label="Mail ID">@if(@$value->status=="A" || @$value->status=="" )
														<p>Active</p>
													...
													<td class="rm07">
														...
														<ul>
															{{-- @if(@$value->status=="A")
															<li><a href="{{route('admin.customer.deactive',$value->id)}}">Deactive</a></li>
															@elseif(@$value->status=="U")
															<li><a href="{{route('admin.customer.active',$value->id)}}">Deactive</a></li>
															@else
															<li><a href="{{route('admin.customer.active',$value->id)}}">Active</a></li>
															@endif
														
															
															<li><a onclick="return confirm('Are you sure want to delete this customer ?')" href="{{route('admin.customer.delete',$value->id)}}">Delete</a></li> --}}

															<li><a href="{{route('admin.customer.view',$value->id)}}">View</a></li>
