                        ...
                        <div>
                            ...
                            <div class="panel panel-default panel-fill">
                                <div class="panel-body rm02 rm04">
                                    ...
                                    <form role="form" action="{{ route('admin.update.service') }}" id="frm"
                                        ...
                                        <div class="form-group rm50">
                                            ...
                                            <select class="form-group" name="category_id" id="category_id">
                                                ...
                                                @foreach ($cat as $val)
                                                    <option value="{{ $val->id }}"
                                                        @if ($val->id == $service->serviceCategoryDetails->category_id) selected @endif>
                                        ...
                                        <div class="form-group rm50">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter service name"
                                                name="service" value="{{ $service->service }}">
                                        </div>

                                        <div class="clearfix"></div>
                                        <div class="form-group rm50">
                                            <label for="title">service Description</label>
                                            <textarea class="form-control" placeholder="Enter service description" id="editor" name="description">{{ $service->description }}</textarea>
                                        </div>
                                        ...
                                        <div class="form-group rm50">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter unity"
                                                name="price_basis" value="{{ $service->price_basis }}">
                                        </div>
                                        <div class="clearfix"></div>
                                        {{--  <div class="form-group rm50">
                                            <label for="title">Video URL</label>
                                            <input type="text" class="form-control" placeholder="Enter Video URL"
                                                name="video_url" value="{{ $service->video_url }}">
                                        </div>  --}}
                                        <div id="dynamic-fields-container">
                                            @if(count(explode(",",$service->video_url)) > 0)
                                            @foreach(explode(",",$service->video_url) as $index => $video_url)
                                            <div class="row">
                                                <div class="col-md-10">
                                                    <div class="form-group rm50">
                                                        <label for="title">Video URL</label>
                                        ...
                                        <div class="form-group" style="margin-left: 30px;">
                                            ...
                                            <div class="uplodimgfilimgs">
                                                <em><img src="{{ url('/') }}/storage/app/public/service/{{ @$service->image }}"
                                                        alt=""
                                        ...
                                        <div class="form-group" style="margin-left: 30px;">
                                            ...
                                            <div class="uplodimgfilimgs">
                                                ...
                                                <em><img src="{{ url('/') }}/storage/app/public/service/{{ @$image }}"
                                                        alt=""
                                                        style="width: 150px !important; height: 150px !important"></em>
                                                @endforeach
                                            </div>
