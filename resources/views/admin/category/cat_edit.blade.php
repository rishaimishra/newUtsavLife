...
@section('title')
<title>Utsavlife | admin | Event Edit</title>
@endsection
@section('left_part')
							...
							<div class="panel-body rm02 rm04">
								...
								<form role="form" action="{{route('admin.update.category')}}" id="frm" method="post" enctype="multipart/form-data">
									...
									<div class="form-group rm50">
										...
										<input type="text"  class="form-control"  placeholder="Enter Event name"  name="category_name" value="{{@$cat->category_name}}" >
									</div>
									<div class="clearfix"></div>
									<div class="form-group rm50">
										<label for="title">Event Description</label>
										<textarea  class="form-control"  placeholder="Enter Event description"  name="category_description" >{{@$cat->category_description}}</textarea>
									</div>
									{{-- image --}}
