...
@section('title')
<title>Utsavlife | Customer | Login</title>
@endsection
{{-- @section('head') --}}
                ...
                <div class="login_header">
                    <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a href="{{route('cust.login.view')}}" class="nav-link active" >Customer Login</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a href="{{route('vandor.login.view')}}" class="nav-link" >Vendor Login</a>
                        </li>
                        <li class="nav-item" role="presentation">
                ...
                <div class="tab-content mt-5" id="myTabContent">
                    <div class="tab-pane fade show active" id="customer" role="tabpanel" aria-labelledby="home-tab">
                        <div class="login_form shadow">
                            <form  method="POST" action="{{ route('cust.login.post') }}" id="login_form">
                                @csrf
                                <input type="hidden" name="type" value="web">
                                <input type="hidden" style="width:500px" name="prev_url" value="{{@$prev_url}}">
                                ...
                                <div class="input_footer">
                                    ...
                                    <a href="{{route('cust.fgp.enter.mail.page')}}">Forgot Password?</a>
                                </div>
                                <div class="input_footer">
                            ...
                            <div class="input_footer mt-4">
                                <a href="{{route('cust.login.otp.enter.mail')}}"> <span>Login Through OTP</span></a>
                            </div>
                            <div class="social_login">
                                <form method="post" action="{{route('login.social',['user_type'=>'user','provider_type'=>'google'])}}">
                                    @csrf
                                    <input type="hidden" name="prev_url" value="{{@$prev_url}}">
                                    <button type="submit" class="common-btns custom_btn_social google-btn"><img src="{{url('/')}}/public/newDesignAsset/dist/images/google.png" style="width:100%;"></button>
                                </form>
                                <form method="post" action="{{route('login.social',['user_type'=>'user','provider_type'=>'facebook'])}}">
                                    @csrf
                                    <input type="hidden" name="prev_url" value="{{@$prev_url}}">
                                    <button type="submit" class="common-btns custom_btn_social facebook-btn"> <img src="{{url('/')}}/public/newDesignAsset/dist/images/fb.png" style="width:100%;"></button>
                                </form>
