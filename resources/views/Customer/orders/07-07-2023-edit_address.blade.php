...
<section class="cart-page-area section-padding">
	<div class="container">
		...
		<div class="cart-itmes">
			<div class="row">
				...
				<form method="POST" action="{{ route('cust.address.update') }}"  class="form-horizontal m-t-20" id="reg_form">
					@csrf
					{{-- ----------- Start New Changes ----------- --}}
					<input type="hidden" name="id" value="{{$data->id}}">
					<div class="form-group mt-3">
						<label >Customer Name</label>
						<input type="text" name="billing_name" id="billing_name" class="form-control" value="{{$data->billing_name}}" >
					</div>
					<div class="form-group mt-3">
						<label >Customer Mobile</label>
						<input type="number" name="billing_mobile" id="billing_mobile" class="form-control" value="{{$data->billing_mobile}}" >
					</div>
					
					<div class="form-group my-3">
						<label for="address_address">Delivary Address</label>
						<input type="text" id="address-input" name="address_address" class="form-control map-input" value="{{$data->address}}">
					...
					<div class="form-group mt-3">
						...
						<input type="number" name="pin_code" id="pin_code" class="form-control" value="{{$data->pin_code}}" >
					</div>
					<div class="form-group mt-3">
						<label >House No/Flat No/ Building No</label>
						<input type="text" name="house_number" id="house_number" class="form-control" value="{{$data->house_number}}" >
					</div>
					<div class="form-group mt-3">
					...
					<div class="form-group mt-3">
						...
						<input type="text" name="landmark" id="landmark" class="form-control" value="{{$data->landmark}}" >
					</div>
	...
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDRAmsF9KgfreNSSBPDZ24xm3a6-7fI2fQ&libraries=places&callback=initialize" async defer></script>
	<script>
	function initialize() {
...
{{-- <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.3/jquery.min.js"></script> --}}
	<script>
		...
		function getGeoLocation(Lat,Long){
			...
			$.ajax({
			url:`https://maps.googleapis.com/maps/api/geocode/json?latlng=${Lat},${Long}&key=AIzaSyDRAmsF9KgfreNSSBPDZ24xm3a6-7fI2fQ`,
			type:'GET',
			// contentType: false,
			// processData: false,
