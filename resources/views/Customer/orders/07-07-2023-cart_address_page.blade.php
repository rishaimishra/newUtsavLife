        ...
        <div class="cart-itmes">
            <div class="row">
               ...
               <button onclick="fetchAddres()" style="border: none;
                ...
                <form method="POST" action="{{ route('cust.cart.address.ins') }}"  class="form-horizontal m-t-20" id="reg_form">
                    @csrf
                    {{-- ----------- Start New Changes ----------- --}}
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input type="number" name="billing_mobile" id="billing_mobile" class="form-control" >
                    </div>
                    ...
                    <h4 style="font-size: 18px;font-weight: 600;margin: 26px 0 10px;">Add Delivery instraction</h4>
                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Dolor reiciendis deleniti explicabo commodi distinctio quo quod voluptate quam quae atque.</p> --}}
                    <div class="form-group mt-3">
