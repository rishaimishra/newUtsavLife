        ...
        <div class="container">
            ...
            <div class="cart-itmes">
                <div class="row">
                    ...
                    <form method="POST" action="{{ route('cust.address.update') }}"  class="form-horizontal m-t-20 box_form_address" id="reg_form">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mt-3">
                                    <label >Customer Name</label>
                                    <input type="text" name="billing_name" id="billing_name" placeholder="Customer Name" class="form-control" value="{{$data->billing_name}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mt-3">
                                    <label >Customer Mobile</label>
                                    <input type="number" name="billing_mobile" id="billing_mobile" placeholder="Customer Mobile" class="form-control" value="{{$data->billing_mobile}}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group my-3">
                                    ...
                                    <input type="text" id="address-input" name="address_address" placeholder="Delivery Address" class="form-control map-input"  value="{{$data->address}}">
                                    <input type="hidden" name="address_latitude" id="address-latitude" value="{{$data->lat}}" />
                                    <input type="hidden" name="address_longitude" id="address-longitude" value="{{$data->long}}" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mt-3">
                                    ...
                                    <input type="number" name="pin_code" id="pin_code" class="form-control" placeholder="Pin Code" value="{{$data->pin_code}}" >
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mt-3">
                                    <label >House No/Flat No/ Building No</label>
                                    <input type="text" name="house_number" id="house_number" class="form-control" placeholder="House No" value="{{$data->house_number}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mt-3">
                                    <label >Area, Street, Village, sector</label>
                                    <input type="text" name="area" id="area" class="form-control" placeholder="Area, Street, Village" value="{{$data->area}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mt-3">
                                    <label >Landmark</label>
                                    <input type="text" name="landmark" id="landmark" class="form-control" placeholder="Landmark" value="{{$data->landmark}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mt-3">
                                    ...
                                    <select class="form-control" name="country" style="background: #d5d7f3">
                                       ...
                                       @foreach($allCountry as $val)
                                        <option value="{{$val->id}}"  @if(@$val->id==@$data->country) selected  @endif>{{@$val->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12 form-group mt-3">
                                <label >City</label>
                                <input type="text" name="city" id="city" class="form-control" placeholder="City" value="{{$data->city}}">
                            </div>
                            <div class="col-md-6 col-12 form-group mt-3">
                                <label >State</label>
                                <input type="text" name="state" id="state" class="form-control" placeholder="State" value="{{$data->state}}">
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mt-3">
                                    ...
                                    <select name="for_address" id="for_address" class="select-form">
                                        <option value="self" @if($data->for_address=="self") selected @endif>Self</option>
                                        <option value="family"  @if($data->for_address=="family") selected @endif>Family</option>
                                        <option value="friend"  @if($data->for_address=="friend") selected @endif>Friend</option>
                                        <option value="other"  @if($data->for_address=="other") selected @endif>Other</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mt-3">
                                    ...
                                    <select name="address_type" id="address_type" class="select-form">
                                        ...
                                        <option value="office" @if($data->address_type=="office") selected @endif>Office</option>
                        ...
                        <label >Do you want this address as Default Address?</label>
                            <br>
                            <input type="radio" id="default_address" name="default_address" value="N" @if(@$data->default_address=="N") checked @endif>No
                            <input type="radio" id="default_address" name="default_address" value="Y" @if(@$data->default_address=="Y") checked @endif>Yes
                        </div>
                        <br>
                        ...
                        <button class="btn btn-primary btn-lg w-lg waves-effect waves-light rm01 mt-5"  type="submit">Edit Address</button>
