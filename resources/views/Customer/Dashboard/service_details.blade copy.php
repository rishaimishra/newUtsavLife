...
.show {
  ...
  .small-img .icon-right { right: 0 !important; }

  .small-img .icon-left:hover, .small-img .icon-right:hover { opacity: .5 !important; }
  ...
  .small-container .show-small-img:last-of-type { margin-right: 0 !important; }
{{-- zoom on hover plugin end  --}}
</style>
      ...
      <div class="modal-content">
         ...
         <form action="{{ route('cust.add_to_cart.new') }}" method="POST" id="frm">
            ...
            <div class="modal-body">
               ...
               <div class="modal-design" style="display:none;" class="form-control">
