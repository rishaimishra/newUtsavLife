   ...
   <div class="services_tiles shadow">
      ...
      <div class="services_details">
         ...
         <div class="services_quantity_till">
            ...
            @if(!@Auth::user()->id)
            <div class="input_label">
               <button  href="#" data-bs-toggle="modal" data-bs-target="#myModalviewNew{{$row->id}}"><img src="{{url('/')}}/public/newDesignAsset/dist/images/cart_ic_blue.png"> ADD</button>
      ...
      <form action="{{ route('cust.add_to_cart.new') }}" method="POST" id="frm{{$row->id}}">
         ...
         <div class="modal-body">
            ...
            <div class="modal-design">
               ...
               <input type="number" class="quentity" name="quantity" id="quantityModal{{$row->id}}" value="1" min="1" onchange="changeQuantity2({{$row->id}})">
            </div>
            <div class="modal-design">
               <label for="">Days</label>
               <input type="number" readonly class="quentity" name="days" id="days{{$row->id}}" value="1" min="1">
            </div>
            <!-- </div> -->
         </div>
...
<div class="section_padding">
  <div class="container">
    ...
    <div class="row">
       @if(!empty(@$hpData->category))
       @foreach(@$hpData->category as $row)
       ...
       <div class="col-md-6">
        <div class="subscription_tiles">
         ...
         <form class="subscription_form">
           <input type="text" class="shadow" placeholder="Your email address" name="">
    ...
    <div class="owl-carousel testimonial_slide">
      <div class="testimonial_tiles shadow">
        ...
        <div class="testimonial_content mt-3">
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla augue urna, aliquet in neque at, gravida dignissim velit. Aenean congue nisl dolor, ac elementum.</p>
        </div>
      </div>
      <div class="testimonial_tiles shadow">
        <div class="testimonial_title">
