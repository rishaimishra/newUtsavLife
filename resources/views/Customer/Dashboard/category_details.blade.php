...
@section('title')
<title>Utsavlife | Category Details</title>
@endsection
{{-- @section('head') --}}
...
<div class="section_padding bg_shadw">
   <div class="container">
      <div class="section_title">
          <h1 class="new-heading mt-4 text-center" style="background: #f7f7f7;width: 100%;padding: 12px;border-radius: 5px;font-size: 18px;">Services under {{@$category_details->category_name}}</h1>
       ...
       <div class="row">
        ...
        <div class="col-md-4 col-lg-3 col-sm-6">
         ...
         <div class="empty-state__icon">
            ...
            <h4 class="empty-state__message">No Sevice Found under this event!</h4>
         </div>
         @endif
      </div>
