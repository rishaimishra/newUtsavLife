...
@section('title')
    <title>Utsavlife | Customer | Update email | Enter Otp</title>
@endsection
{{-- @section('head') --}}
            ...
            <div class="col-lg-6 offset-lg-3">
                <div class="login_wrap_area">
                    <div class="loginwrap">
                        ...
                        <div class="form_title text-center mt-3">
                            <h4 class="mb-5">Update Email (Enter otp)</h4>

                        </div>
                        @include('Customer.includes.message')
                        {{--  <form method="POST" action="{{route('cust.email.update.part.two')}}" id="frm">
                            @csrf
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary login-btn" name="login">Update Email</button>
                            </div>

                        </form>  --}}
                        <form class="box_form shadow" id="myForm" action="{{ route('cust.email.update.part.two') }}" method="POST">
                            @csrf
                            ...
                            <div class="row justify-content-md-center">
                                ...
                                <button type="submit" class="btn btn_shadow_theme">Update Email</button>
                              </div>  --}}
                                        </div>
                                    </div>
                                </div>
